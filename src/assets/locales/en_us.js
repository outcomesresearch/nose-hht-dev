...
export default {
  ...
  [keys.LOAD_PAST_SCORES]: 'View past scores',
  [keys.EMAIL_DISCLAIMER_1]:
    'Washington University School of Medicine uses this email address as an identifier to store your past NOSE-HHT scores generated by this online questionnaire.',
  [keys.EMAIL_DISCLAIMER_2]:
    'This email address is not used to advertise, market, or otherwise contact you, and only serves as an ID by which to link your past scores together and retrieve them here.',

  [keys.AUTHENTICATE_YOURSELF]: 'Log in with email',
  [keys.CLOSE]: 'Close',
  [keys.BACK]: 'Back',
